...
<html lang="en">
    <head>
        ...
        <?php require "components/actions-edit-package.php"; ?>
    </head>
    <body class="body-bg">
        ...
        <main class="main">
            ...
            <section class="main-content">
                ...
                <form action="<?= $_SERVER['PHP_SELF']; ?>" method="post" class="users-refund-detail-form fieldset-relative">
                    ...
                    <span class="admin-page-heading">Update Package</span>
<?php if($message_err != ''){?>
...
<?php }?>
                    ...
                    <div class="user-refund-btn">
                        <button type="submit" class="btn force-bg-blue" name="submit_package_btn" >Update Package</button>
                    </div>
                </form>
            </section>
        </main>
