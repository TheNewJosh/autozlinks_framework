...
<!--                        <a class="btn force-bg-red">Delete</a>-->
        ...
        <script>
            $(document).ready(function(){
                var user_id = new URL(window.location.href).searchParams.get("user_id");     var data_tid = "5";     
                 $.ajax({
                    url: "components/aaa-select-table.php", 
                    method:"POST",
                    data:{get_coin_bought_all:"get_coin_bought_all", user_id:user_id, data_tid:data_tid},
                    dataType: "json",
                ...
                $('#body-div-serach').change(function(){
                    ...
                    $.ajax({
                        url: "components/aaa-select-table.php", 
                        method:"POST",
                        data:{search_coin_bought_all:"search_coin_bought_all", search_query:search_query, user_id:user_id, data_tid:data_tid},
                        dataType: "json",
                        success: function(data){
                            if(data.status == 1){
                                var state = {
