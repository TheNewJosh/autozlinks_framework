...
<html lang="en">
    <head>
        ...
        <?php require "components/actions-edit-payment-paystack.php"; ?>
    </head>
    <body class="body-bg">
...
<?php }?>
                    <div class="display-flex-column azc-input-group">
                        ...
                        <div class="input-group-lon fieldset-relative">
                            <input type="email" name="paystack_email" value="<?= $paystack_email ?>" placeholder="Type here" />
                            <span class="refund-input-legend-two force-color-blue">Paystack Email</span>
                            <br/><span class="force-color-red"><?= $paystack_email_err ?></span>
                        </div>
                        <div class="input-group-lon fieldset-relative">
                        ...
                        <span class="table-heading-text" ><br><br><b>Test API</b></span>
                        <div class="input-group-lon fieldset-relative">
                            <input type="text" name="test_server_key" value="<?= $test_server_key ?>" placeholder="Type here" />
                            <span class="refund-input-legend-two force-color-blue">Test Server Key</span>
                            <br/><span class="force-color-red"><?= $test_server_key_err ?></span>
                        </div>
                        <div class="input-group-lon fieldset-relative">
                            <input type="text" name="test_private_key" value="<?= $test_private_key ?>" placeholder="Type here" />
                            <span class="refund-input-legend-two force-color-blue">Test Private Key</span>
                            <br/><span class="force-color-red"><?= $test_private_key_err ?></span>
                        </div>
                        <span class="table-heading-text" ><br><br><b>Live API</b></span>
                        <div class="input-group-lon fieldset-relative">
                            <input type="text" name="live_server_key" value="<?= $live_server_key ?>" placeholder="Type here" />
                            <span class="refund-input-legend-two force-color-blue">Live Server Key</span>
                            <br/><span class="force-color-red"><?= $live_server_key_err ?></span>
                        </div>
                        <div class="input-group-lon fieldset-relative">
                            <input type="text" name="live_private_key" value="<?= $live_private_key ?>" placeholder="Type here" />
                            <span class="refund-input-legend-two force-color-blue">Live Private Key</span>
                            <br/><span class="force-color-red"><?= $live_private_key_err ?></span>
                        </div>
                    </div>
                    <div class="user-refund-btn">
                        <button type="submit" class="btn force-bg-blue" name="submit_payment_paystack_btn">Update</button>
                    </div>
                </form>
            </section>
        </main>
