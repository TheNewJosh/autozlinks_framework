            ...
            $(document).ready(function(){
                ...
                var data_tid = "1";
                 ...
                 $.ajax({
                    ...
                    method:"POST",
                    data:{get_money_transact_all_1:"get_money_transact_all_1", user_id:user_id, data_tid:data_tid},
                    dataType: "json",
                ...
                $('#body-div-serach').change(function(){
                    ...
                    $.ajax({
                        url: "components/aaa-select-table.php", 
                        method:"POST",
                        data:{search_money_transact_all_1:"search_money_transact_all_1", search_query:search_query,user_id:user_id, data_tid:data_tid},
                        dataType: "json",
                        success: function(data){
                            if(data.status == 1){
                                var state = {
