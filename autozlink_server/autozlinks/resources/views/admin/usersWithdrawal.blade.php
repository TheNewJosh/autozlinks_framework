...
<!--                        <a class="btn force-bg-red">Delete</a>-->
        ...
        <script>
            $(document).ready(function(){
                var user_id = new URL(window.location.href).searchParams.get("user_id");     var data_tid = "6";     
                 $.ajax({
                    url: "components/aaa-select-table.php", 
                    method:"POST",
                    data:{get_money_transact_all_6:"get_money_transact_all_6", user_id:user_id, data_tid:data_tid},
                    dataType: "json",
                ...
                $('#body-div-serach').change(function(){
                    ...
                    $.ajax({
                        url: "components/aaa-select-table.php", 
                        method:"POST",
                        data:{search_money_transact_all_6:"search_money_transact_all_6", search_query:search_query, user_id:user_id, data_tid:data_tid},
                        dataType: "json",
                        success: function(data){
                            if(data.status == 1){
                                var state = {
