            ...
            $(document).ready(function(){
                var user_id = new URL(window.location.href).searchParams.get("user_id");              
                 $.ajax({
                    ...
                    method:"POST",
                    data:{get_package_ads_all:"get_package_ads_all", user_id:user_id},
                    dataType: "json",
                ...
                $('#body-div-serach').change(function(){
                    ...
                    $.ajax({
                        url: "components/aaa-select-table.php", 
                        method:"POST",
                        data:{search_package_ads_all:"search_package_ads_all", search_query:search_query,user_id:user_id},
                        dataType: "json",
                        success: function(data){
                            if(data.status == 1){
                                var state = {
