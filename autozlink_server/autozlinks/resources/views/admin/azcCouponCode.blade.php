            ...
            <section class="main-content">
                ...
                <div class="dashboard-azc-area-btn">
                    <div class="display-flex-row">
                        <a href="azc-coupon-code-create.php" class="btn force-bg-blue">Create</a>
                    ...
                    <div class="display-flex-row-justify-end alert hide" id="alert-save">
                        ...
                        <span class="table-heading-text parallax-slider-message"><b>Successfully Create</b></span>
                    </div>
        ...
        <script>
            $(document).ready(function(){   
                 $.ajax({
                    ...
                    method:"POST",
                    data:{get_coupon_code_all:"get_coupon_code_all"},
                    dataType: "json",
                ...
                $('#body-div-serach').change(function(){
                    ...
                    $.ajax({
                        url: "components/aaa-select-table.php", 
                        method:"POST",
                        data:{search_coupon_code_all:"search_coupon_code_all", search_query:search_query},
                        dataType: "json",
                        success: function(data){
                            if(data.status == 1){
                                var state = {
